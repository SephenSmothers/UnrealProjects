...
public: \
	DECLARE_CLASS(ATestingVariable, AActor, COMPILED_IN_FLAGS(CLASS_Abstract | CLASS_Config), CASTCLASS_None, TEXT("/Script/A__SmothersSephen"), NO_API) \
...
#define A__SmothersSephen_Source_A__SmothersSephen_Public_Testing_TestingVariable_h_14_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, ATestingVariable); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(ATestingVariable); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API ATestingVariable(ATestingVariable&&); \
	NO_API ATestingVariable(const ATestingVariable&); \
public:
...
#define A__SmothersSephen_Source_A__SmothersSephen_Public_Testing_TestingVariable_h_14_PRIVATE_PROPERTY_OFFSET \
	...
	FORCEINLINE static uint32 __PPO__VisibleInstanceOnly() { return STRUCT_OFFSET(ATestingVariable, VisibleInstanceOnly); } \
	FORCEINLINE static uint32 __PPO__EditAnywhere() { return STRUCT_OFFSET(ATestingVariable, EditAnywhere); } \
	FORCEINLINE static uint32 __PPO__EditDefaultsOnlyOdd() { return STRUCT_OFFSET(ATestingVariable, EditDefaultsOnlyOdd); } \
...
template<> A__SMOTHERSSEPHEN_API UClass* StaticClass<class ATestingVariable>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID A__SmothersSephen_Source_A__SmothersSephen_Public_Testing_TestingVariable_h
